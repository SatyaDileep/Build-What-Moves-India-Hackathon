  ...
  return (
    ...
    >
      ...
      {Array.from({ length: 24 }).map((_, i) => {
        ...
        const x1 = (12 + 1.9 * Math.cos(angle)).toFixed(3);
        const y1 = (12 + 1.9 * Math.sin(angle)).toFixed(3);
        const x2 = (12 + 8.2 * Math.cos(angle)).toFixed(3);
        const y2 = (12 + 8.2 * Math.sin(angle)).toFixed(3);
