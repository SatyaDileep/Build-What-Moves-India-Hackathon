...
chrome.storage.local.get(['docbridge_stats','docbridge_nudge_enabled','docbridge_assist_mode','docbridge_voice_enabled','docbridge_selected'],function(data){
  ...
  document.getElementById('toggle-voice').checked=data.docbridge_voice_enabled===true;
...
document.getElementById('toggle-voice').addEventListener('change',function(){ chrome.storage.local.set({docbridge_voice_enabled:this.checked}); });
